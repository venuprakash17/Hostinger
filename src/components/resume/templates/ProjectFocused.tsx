 ...
 * For tech freshers - highlights academic and personal projects
 * Projects section immediately after summary
 */
...
interface ProjectFocusedProps {
  resumeData: ResumeData;
  className?: string;
}

export function ProjectFocused({ resumeData, className = '' }: ProjectFocusedProps) {
  ...
  return (
    <div className={`resume-template project-focused ${className}`} style={{
      ...
      {/* Projects - Moved to top after summary */}
        ...
        <div style={{ marginBottom: '12px' }}>
          ...
          <ul style={{ margin: 0, paddingLeft: '20px' }}>
            {certifications.map((cert, idx) => (
              <li key={idx} style={{ fontSize: '10pt', marginBottom: '3px' }}>
