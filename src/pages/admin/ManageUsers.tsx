...
export default function ManageUsers() {
  ...
  const fetchCollegeAdmin = async () => {
    ...
    if (roleData?.college_id) {
      setCollegeId(roleData.college_id);
    }
  };
    ...
    <div className="container py-8 space-y-8">
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Create and manage students and faculty for your college</p>
        </div>
      </div>
        ...
        <TabsContent value="single">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Add students or faculty to your college
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            ...
            <CardContent>
              <ExcelImport
                ...
                description="The Excel file should contain columns: email, password, full_name, role (student/faculty), and for students: department, section, roll_number"
              />
              ...
              <div className="mt-6 p-4 bg-muted rounded-lg">
                ...
                <ul className="text-sm space-y-1">
                  ...
                  <li><strong>role:</strong> student or faculty (required)</li>
      ...
      <Card className="bg-muted/50">
        ...
        <CardContent className="space-y-2 text-sm">
          <p>• Students and faculty created here will belong to your college</p>
